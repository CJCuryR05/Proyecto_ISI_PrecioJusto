...
<html>
<head>
    <title>Precios de Creppes</title>
    <meta charset="utf-8" />
...
<body>
    <div id="page-wrapper">
        ...
        <div id="main">
            <div class="container">
                <section>
                    <h2 style="text-transform: uppercase;">Precios promedio y moda de Creppes</h2>
                ...
                <section>
                    <h2 style="text-transform: uppercase;">Precios de Creppes en restaurante Creppes And Waffles</h2>
                    <ul class="restaurant-list">
                        <li>
                            <div>
                                <h3>Creppes de lomo arabe</h3>
                                <p>Precio: $20.000 Pesos colombianos</p>
                                <p>Precio: $5 Dolares</p>
                                <p>Precio: $4 Euros</p>
                            </div>
                            <img src="images/Crepe de lomo arabe.jpg" alt="Crepe de lomo arabe">
                        </li>
                        <li>
                            <div>
                                <h3>Creppes de ternera</h3>
                                <p>Precio: $30.000 Pesos colombianos</p>
                                <p>Precio: $7.5 Dolares</p>
                                <p>Precio: $6 Euros</p>
                            </div>
                            <img src="images/Crepe de ternera.jpg" alt="Crepe de ternera">
                        </li>
                        <li>
                            <div>
                                <h3>Creppes mexicano</h3>
                                <p>Precio: $24.000 Pesos colombianos</p>
                                <p>Precio: $6 Dolares</p>
                                <p>Precio: $4.8 Euros</p>
                            </div>
                            <img src="images/Crepe mexicano.jpg" alt="Crepe mexicano">
                        </li>
                        <li>
                            <div>
                                <h3>Creppes de boloñesa, queso y champiñon</h3>
                                <p>Precio: $28.000 Pesos colombianos</p>
                                <p>Precio: $7 Dolares</p>
                                <p>Precio: $5.6 Euros</p>
                            </div>
                            <img src="images/Crepes de boloñesa, queso y champiñon.jpg" alt="Crepes de boloñesa, queso y champiñon">
                        </li>
                        <li>
                            <div>
