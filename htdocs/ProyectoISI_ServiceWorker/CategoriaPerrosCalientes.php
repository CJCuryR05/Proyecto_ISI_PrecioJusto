...
<html>
<head>
    <title>Precios de Perros Calientes</title>
    <meta charset="utf-8" />
...
<body>
    <div id="page-wrapper">
        ...
        <div id="main">
            <div class="container">
			     <section>
                    <h2 style="text-transform: uppercase;">Precios promedio y moda de Perros Calientes</h2>
                    <ul class="promediomoda-list">
                        <?php
                            ...
                            $sql = "SELECT nombrecategoria, preciopromedio, modaprecio FROM categorias WHERE nombrecategoria = 'Perros Calientes (Hot Dogs)'";
				...
				<section>
                    <h2 style="text-transform: uppercase;">Precios de Perros Calientes en El Corral - Vaqueros</h2>
					<ul class="restaurant-list">
						<li>
                            <div>
                                <h3>Perro Caliente Vaquero Callejero</h3>
                                <p>Precio: 20.000 Pesos Colombianos </p>
                                <p>Precio: 5 Dolares </p>
                                <p>Precio: 4 Euros </p>
                            </div>
                            <img src="images/Perro Caliente Vaquero Callejero.jpeg" alt="">
							
                        </li>
                        <li>
                            <div>
                                <h3>Perro Caliente Vaquero Hawaiano</h3>
                                <p>Precio: 20.000 Pesos Colombianos </p>
                                <p>Precio: 5 Dolares </p>
                                <p>Precio: 4 Euros </p>
                            </div>
                            <img src="images/Perro Caliente Vaquero Hawaiano.jpeg" alt="">
                        </li>
                        <li>
                            <div>
                                <h3>Perro Caliente Vaquero Especial</h3>
                                <p>Precio: 28.000 Pesos Colombianos </p>
                                <p>Precio: 7 Dolares </p>
                                <p>Precio: 5.6 Euros </p>
                            </div>
                            <img src="images/Perro Caliente Vaquero Especial.jpeg" alt="">
                        </li>
