...
<html>
<head>
    <title>Precios de Ensaladas</title>
    <meta charset="utf-8" />
...
<body>
    <div id="page-wrapper">
        ...
        <div id="main">
            <div class="container">
			     <section>
                    <h2 style="text-transform: uppercase;">Precios promedio y moda de Ensaladas</h2>
                    <ul class="promediomoda-list">
                        <?php
                            ...
                            $sql = "SELECT nombrecategoria, preciopromedio, modaprecio FROM categorias WHERE nombrecategoria = 'Ensaladas (Salads)'";
				...
				<section>
                    <h2 style="text-transform: uppercase;">Precios de Ensaladas en Sandwich Qbano</h2>
					<ul class="restaurant-list">
						<li>
                            <div>
                                <h3>Ensalada de Pollo</h3>
                                <p>Precio: 22.000 Pesos Colombianos </p>
                                <p>Precio: 5.5 Dolares </p>
                                <p>Precio: 4.4 Euros </p>
                            </div>
                            <img src="images/Ensalada de Pollo.jpeg" alt="">
							
                        </li>
                        <li>
                            <div>
                                <h3>Ensalada Cordero</h3>
                                <p>Precio: 23.000 Pesos Colombianos </p>
                                <p>Precio: 5.75 Dolares </p>
                                <p>Precio: 4.6 Euros </p>
                            </div>
                            <img src="images/Ensalada Cordero.jpeg" alt="">
                        </li>
                        <li>
                            <div>
                            ...
                            <img src="images/Ensalada de Pavo.jpeg" alt="">
                        </li>
