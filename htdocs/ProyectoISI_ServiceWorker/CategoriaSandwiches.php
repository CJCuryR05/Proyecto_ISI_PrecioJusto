...
<html>
<head>
    <title>Precios de Sandwiches</title>
    <meta charset="utf-8" />
...
<body>
    <div id="page-wrapper">
        ...
        <div id="main">
            <div class="container">
                <section>
                    <h2 style="text-transform: uppercase;">Precios promedio y moda de Sandwiches</h2>
                    <ul class="promediomoda-list">
                        <?php
                            ...
                            $sql = "SELECT nombrecategoria, preciopromedio, modaprecio FROM categorias WHERE nombrecategoria = 'Sandwiches'";
                ...
                <section>
                    <h2 style="text-transform: uppercase;">Precios de Sandwiches en Sandwich Qbano</h2>
                    <ul class="restaurant-list">
                        <li>
                            <div>
                                <h3>Sandwich Personal de Pollo</h3>
                                <p>Precio: 18.000 Pesos Colombianos</p>
                                <p>Precio: 4.5 Dólares</p>
                                <p>Precio: 3.6 Euros</p>
                            </div>
                            <img src="images/Sandwich Personal de Pollo.jpeg" alt="Sandwich Personal de Pollo">
                        </li>
                        <li>
                            <div>
                                <h3>Sandwich Personal Especial</h3>
                                <p>Precio: 22.000 Pesos Colombianos</p>
                                <p>Precio: 5.5 Dólares</p>
                                <p>Precio: 4.4 Euros</p>
                            </div>
                            <img src="images/Sandwich Personal Especial.jpeg" alt="Sandwich Personal Especial">
                        </li>
                        <li>
                            <div>
                                <h3>Sandwich Personal Hawaiano</h3>
                                <p>Precio: 22.000 Pesos Colombianos</p>
                                <p>Precio: 5.5 Dólares</p>
                                <p>Precio: 4.4 Euros</p>
                            </div>
                            <img src="images/Sandwich Personal Hawaiano.jpeg" alt="Sandwich Personal Hawaiano">
                        </li>
                    </ul>
                </section>
            </div>
